<img src="https://github.com/Minute-Plumbing/Brand/blob/master/logoBanner.png" alt="react boilerplate banner" align="center" />

<br />

<div align="center"><strong>Plumbing and Heating App</strong></div>
<div align="center">Minute Plumbing and Heating App makes it easier for both the customers and servicemen.</div>
...
<div align="center">
  <sub>Created by <a href="https://www.facebook.com/min.plumber/">Brian Larsen</a> and maintained with ❤️.</sub>
</div>

## Features

<dl>
  <dt>Fast on Demand Quotes</dt>
  <dd>Customers can visually see and pick the fixtures they want and quickly get a quote to install in minutes.</dd>

  <dt>Instant feedback</dt>
  <dd>Customers can schedule appointments directly with servicemen and rate the Servicemen's quality of service.</dd>
...
<sub><i>Keywords: Plumbing, Heating, Quote, Service, Scheduling, Estimator, New Construction, Renovation, Residential, Commercial, Infloor Heating</i></sub>
